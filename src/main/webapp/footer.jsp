...
<footer class="site-footer">
    <div class="container footer-row">
        ...
        <div class="footer-right muted">
            <span id="footerWeather">Weather: locating...</span>
        </div>
    </div>
</footer>
...
(() => {
  ...
  navigator.geolocation.getCurrentPosition(async (position) => {
    ...
    if (error.code === 1) weatherError("permission denied");
    else if (error.code === 2) weatherError("location unavailable");
    else if (error.code === 3) weatherError("location timeout");
    else weatherError("unavailable");
  }, {
